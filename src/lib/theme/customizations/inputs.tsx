                    ...
                    },
                    {
                        ...
                        style: {
                            ...
                            ...theme.applyStyles('dark', {
                                ...
                                backgroundImage: `linear-gradient(to bottom, ${red[500]}, ${red[800]})`,
                                boxShadow: 'none',
                                border: `1px solid ${red[800]}`,
                                '&:hover': {
                                    backgroundImage: `linear-gradient(to bottom, ${red[700]}, ${red[800]})`,
        ...
        styleOverrides: {
            ...
            root: ({ theme }) => ({
                ...
                [`&.${outlinedInputClasses.focused}`]: {
                    outline: 'none', //`3px solid ${alpha(brand[500], 0.5)}`,
                    borderColor: brand[400],
                },
                ...theme.applyStyles('dark', {
                    '&:hover': {
        ...
        styleOverrides: {
            root: () => ({
                ...
                '&.MuiInputLabel-shrink': {
                    transform: 'translate(14px, -9px) scale(0.8)', // Adjust position + scale
                    top: 0
                },
            }),
        },
